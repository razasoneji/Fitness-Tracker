<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Nutrition.aspx.cs" Inherits="FitnessTrackerWebApp.Nutrition" %>
<!DOCTYPE html>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="form-group">
                <asp:Label ID="lblFoodItem" runat="server" Text="Food Item" />
                <asp:TextBox ID="txtFoodItem" runat="server" CssClass="form-control" />
            </div>
            <div class="form-group">
                <asp:Label ID="lblCalories" runat="server" Text="Calories" />
                <asp:TextBox ID="txtCalories" runat="server" CssClass="form-control" />
            </div>
            <div class="form-group">
                <asp:Label ID="lblDateConsumed" runat="server" Text="Date Consumed" />
                <asp:TextBox ID="txtDateConsumed" runat="server" CssClass="form-control" />
            </div>
            <div class="btn-group">
            ...
            <asp:GridView ID="gvNutrition" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" CssClass="grid-view">
                <Columns>
                    ...
                    <asp:BoundField DataField="DateConsumed" HeaderText="Date Consumed" />
                </Columns>
            </asp:GridView>
        </div>
    </form>
